...
function ffxi_install()
{
	...
	if ( $installed_ver != $db_version )
	{
		...
		$sql = "ALTER TABLE ". $wpdb->ffxistats_mission ." ADD COLUMN vision varchar(200) NOT NULL default 'N/A', ADD COLUMN heroes varchar(200) NOT NULL default 'N/A', ADD COLUMN scars varchar(200) NOT NULL default 'N/A'";
